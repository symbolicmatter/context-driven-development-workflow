---
description: >-
  Use when asked to audit CDE/CDDW discipline, assess context-code alignment, review context freshness, detect drift, inspect traceability between specs and implementation, or produce a Coherence Report. Do not use to modify code, update authoritative context, consolidate learning, or enforce release gates.
mode: primary
color: "#6d597a"
permission:
  edit: deny
